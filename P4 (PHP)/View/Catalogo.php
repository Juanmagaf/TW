        ...
        if($_SESSION['username'] == 'jefe'){
            //echo $_SESSION['username'];
                ...
                <section>
                    ...
                    -->
                    <a href="index.php?seccion=comprar&indice='.$libro["Índice"].'" class="enlace">Comprar</a>
                    <a href="index.php?seccion=editar&indice='.$libro["Índice"].'" class="enlace">Editar Libro</a>
                    <a href="index.php?seccion=borrar&indice='.$libro["Índice"].'" class="enlace">Borrar Libro</a>
                    </section>';
                } 
